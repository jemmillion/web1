...
public class DQL_select_PreparedStatement_02 {
	...
	public static void main(String[] args) {
        ...
        */
		...
		// SQL 문이 DQL문(select)이므로 .executeQuery();이다.
		// pstmt.executeQuery(); 을 실행하면 select 되어진 결과물을 가져오는데 그 타입은 ResultSet으로 가져온다.
     ...
     */   
		...
		while(rs.next()) {
			/*
				...
				행이 존재하면 true를 리턴해주고, 행이 없으면 false를 리턴해주는 메소드이다.
			 */
